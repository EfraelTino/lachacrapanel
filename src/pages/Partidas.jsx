...
import { TablaRelacion } from "../components/Tables/TablaRelacion";
import { TwentyOneTrivia } from "../components/Tables/TwentyOneTrivia";
import { Penalti } from "./Penalti";
import { PenaltiRanking } from "../components/Tables/PenaltiRanking";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-1 md:grid-cols-1 md:gap-6 mt-3 space-y-5">
        ...
        <PenaltiRanking  dataSearch={searchTerm}/>
      </div>
    </>
  );
};
